...
== %AJANTIS_BANTER% ~My presence here in the Sword Coast was a matter of responsibility, as you should know well, sir.~
...
== %AJANTIS_BANTER% ~If that is the case, then why are you out here, Drake? I only know what I have heard, but you have served at your current position for nearly a decade, twice the time of a usual term. How is it you have not been granted knighthood yet?~
== BC0DRAKE ~I like it where I am, squire. It helps me keep a closer eye on kids like you.~
== %AJANTIS_BANTER% ~I... see. Surely prelate Durand does not approve.~
...
== %AJANTIS_BANTER% ~Well enough, Sir Caulfield, last I saw of him.~
...
== %AJANTIS_BANTER% ~The personal affairs of my superior are hardly my business, sir. But, yes... from what I have heard, he has had little time to see his family.~
== BC0DRAKE ~So in essence, nothing's changed since I was gone.~
== %AJANTIS_BANTER% ~Why does this matter concern you so? Sir Keldorn has rarely spoken of you in the past. I was not aware you were friends.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeAjantis3","GLOBAL",0)~ THEN %AJANTIS_BANTER% C0DrakeAjantis3
...
== %AJANTIS_BANTER% ~I see little of the venerable prelate, but he always seemed a fair, yet often agitated man.~
== BC0DRAKE ~That's not entirely because of the Order, actually. Half of it must be because I drive him up the wall.~
== %AJANTIS_BANTER% ~For shame, Drake! Do you have no respect for your own father?~
== BC0DRAKE ~Make no mistake, kid, I like my father just fine. I just don't always agree with him, is all.~
== %AJANTIS_BANTER% ~That is hardly an excuse for all of your... inappropriate behaviour!~
...
== %AJANTIS_BANTER% ~Do you... disagree with the Order's methods?~
...
== %ALORA_BANTER% ~Ooh, pretty... whoops! H-hey, Drakey. What's up?~
== BC0DRAKE ~My face, glaring down at you with disapproval. I think you know why.~
== %ALORA_BANTER% ~Wh-what? I don't have a clue what you're talking about.~
== BC0DRAKE ~Give it back.~
== %ALORA_BANTER% ~Aw, but I don't want toooo! It's too cute!~
== BC0DRAKE ~You give that to me right now... young lady.~
== %ALORA_BANTER% ~Hmf... okay, okay. But I didn't think a gruff, big guy like you would carry around a little glass pony like that. Hee-hee... got a little secret or two?~
== BC0DRAKE ~Not in the way you'd think, kid. It's a present from my little sister.~
== %ALORA_BANTER% ~Oh. I'm sorry, Drakey, I didn't know. But you shouldn't keep something as valuable as that in your pocket. What if someone steals it?~
== BC0DRAKE ~You mean someone like you?~
== %ALORA_BANTER% ~Er, right. I get your point. Sorry, I won't do it again.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeAlora2","GLOBAL",0)~ THEN %ALORA_BANTER% C0DrakeAlora2
...
== %ALORA_BANTER% ~Hee-hee! No can do, I'm under contract to bother you until you smile! I'm being a good samaritan here!~
...
== %ALORA_BANTER% ~Aww, you don't like Drakey? I thought the name was cute!~
...
== %ALORA_BANTER% ~Pooh, so I'm not cute enough, is that it? Well, you just wait, Drakey! I'll become so sweet your teeth will rot off! Just you wait and see, hmf!~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeBranwen1","GLOBAL",0)~ THEN %BRANWEN_BANTER% C0DrakeBranwen1
...
== %BRANWEN_BANTER% ~Now... whatever could you be implying, hmm? I was merely making an offhand comment about your prowess in battle.~
== BC0DRAKE ~I have prowess in more fields than just battle, milady.~
== %BRANWEN_BANTER% ~Do you now? That is good to know. Do you like knitting, I wonder? My favorite socks could use some patching.~
== BC0DRAKE ~Your act doesn't fool me, Branwen.~
== %BRANWEN_BANTER% ~A shame. I was starting to have fun.~
EXIT
...
== %BRANWEN_BANTER% ~What is it, Drake? What could I possibly be doing to offend you?~
== BC0DRAKE ~No, no, don't ask, just do that motion again, but using this stick instead for safety.~
== %BRANWEN_BANTER% ~As you wish. Hah! Tempus!~
...
== %BRANWEN_BANTER% ~I find that my technique makes the most use of my arm's strength. Would you not agree?~
...
== %BRANWEN_BANTER% ~I do not appreciate you presuming to teach me in warfare, Drake. My skills were bestowed upon me by the battlemasters of Tempus.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeCoran1","GLOBAL",0)~ THEN %CORAN_BANTER% C0DrakeCoran1
...
== %CORAN_BANTER% ~I thought perhaps we could bond over a more... cultured drink. As it happens, I have a bottle of the finest Elverquisst, brewed in faraway Evereska. How about it?~
...
== %CORAN_BANTER% ~Err... perhaps I should show you the proper methods to enjoying elven beverages. One step at a time, then...~
EXIT
...
!See([ENEMY])
AreaType(CITY)
Global("C0DrakeCoran2","GLOBAL",0)~ THEN %CORAN_BANTER% C0DrakeCoran2
...
== %CORAN_BANTER% ~Erm... yes, but what of her fair features? Have any thoughts on that?~
...
== %CORAN_BANTER% ~I'll take your word for it. But how about you, hmm? Perhaps she'd have more success with one of her own kind?~
== BC0DRAKE ~Like I said, she's too skinny.~
== %CORAN_BANTER% ~Fair enough.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeCoran3","GLOBAL",0)~ THEN %CORAN_BANTER% C0DrakeCoran3
...
== %CORAN_BANTER% ~'Filch' is such an ugly word, my friend. I merely saw fit to make sure nothing had gone missing. The thought of informing you just, er, slipped my mind.~
== BC0DRAKE ~I'm sure it's not the first thought to do so. Your mind is more slippery than a sweaty merchant's backside.~
== %CORAN_BANTER% ~Guilty as charged, my friend, but back on track here... those... trinkets cannot truly be your own, can they? A straw doll and wooden toy soldier? Not to mention the horse made of pink glass? That's not like you.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeDynaheir1","GLOBAL",0)~ THEN %DYNAHEIR_BANTER% C0DrakeDynaheir1
...
== %DYNAHEIR_BANTER% ~True, but thou wouldst seem to place thy personal desires upon a higher priority than thy creed.~
== BC0DRAKE ~Is that so, madam? 'Hath' I ever failed to do my duty, under 'thy' eye? Did I allow Bassilus to walk free?~
== %DYNAHEIR_BANTER% ~Thou shifted the burden of thy duty to <CHARNAME>'s shoulder. And thy mockery of me is most unseemly.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeDynaheir2","GLOBAL",0)~ THEN %DYNAHEIR_BANTER% C0DrakeDynaheir2
~Thou art of noble birth, art thou not, Drake?~
DO ~SetGlobal("C0DrakeDynaheir2","GLOBAL",1)~
== BC0DRAKE ~Aye, that I am, madam witch.~
== %DYNAHEIR_BANTER% ~I wouldst ne'er have imagined it. Thy demeanor is quite opposite to the nobility I hath known.~
...
== %DYNAHEIR_BANTER% ~I see. But true nobility, beyond mere extravagance, is a matter of action, rather than blood. Thy actions mayst still be worthy of the title of noble. Wouldst thou not agree?~
...
== %EDWIN_BANTER% ~I wear this color as a symbol of color and prestige, drunkard. I see you do not wear anything of the like. Or are my words beyond your understanding?~
...
== %EDWIN_BANTER% ~I see. In that case, I think it is apt to return the favor by informing you that you would be worth little more than a common indentured laborer in grand Thay.~
...
== %EDWIN_BANTER% ~Better, fool. Thayvian slaves are thrown to the gladiator pits, where they are matched against other beasts like themselves for the amusement of more enlightened beings.~
...
== %EDWIN_BANTER% ~Why you insolent... this foolish bickering is beneath me. Be a good simian and find your amusement elsewhere. Perhaps you might find yourself a banana. (Yes, I am certain that would keep you preoccupied...)~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeEldoth1","GLOBAL",0)~ THEN %ELDOTH_BANTER% C0DrakeEldoth1
...
== %ELDOTH_BANTER% ~What's this? You would actually prefer to be insulted than praised? You are a rare kind indeed! Come witness, <CHARNAME>, I believe we have ourselves a never-before seen beast!~
...
== %ELDOTH_BANTER% ~I believe I will rescind my previous impression of you after all. You actually are more of a fool than I initially expected. Quite impressive.~
EXIT
...
== %ELDOTH_BANTER% ~I am certain any advice you give would be better recited to a mule, but do tell. It could be amusing.~
...
== %ELDOTH_BANTER% ~Are you implying that my tunes could kill? I'm not sure whether to feel flattered or insulted.~
...
== %ELDOTH_BANTER% ~Why don't you guard my side in our next skirmish then, to see if that holds true? I will be sure to reserve a poisoned arrow or two... for the sake of demonstration, of course.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeFaldorn","GLOBAL",0)~ THEN %FALDORN_BANTER% C0DrakeFaldorn
...
== %FALDORN_BANTER% ~Pfeh! If we frequented the forest more often, I would cleanse myself of city filth in an instant. Sadly, that is not to be.~
== BC0DRAKE ~Then perhaps people in glass houses shouldn't throw stones.~
== %FALDORN_BANTER% ~The stench I speak of is that born of your addiction to those foul city-made brews. No doubt they have poisoned your mind as much as your body.~
== BC0DRAKE ~So I drink a little. What harm does that do to anyone else? At least I don't cut down trees for a living.~
== %FALDORN_BANTER% ~True, but you are content to drown yourself within the filth of humanity, wasting away the life Nature has granted you. That alone is an offense to me.~
...
== %FALDORN_BANTER% ~Your ignorance revolts me. I will speak with you no further.~
EXIT
...
== %GARRICK_BANTER% ~There is surely no cause for such hurtful words, sir. My bardic skills may not be the most refined, but I put every ounce of my soul into my performance.~
== BC0DRAKE ~What soul you have must be heavily diminished if it is measured in mere ounces.~
== %GARRICK_BANTER% ~How rude! Have I done something to offend you, sir, that you would insult me in such a fashion?~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeImoen1_BG1","GLOBAL",0)~ THEN %IMOEN_BANTER% C0DrakeImoen1
~Hey, hey, Drake! Got a minute?~
DO ~SetGlobal("C0DrakeImoen1_BG1","GLOBAL",1)~
== BC0DRAKE ~Not now, kid. Go play somewhere else.~
== %IMOEN_BANTER% ~Pooh! You're such a jerk! Aren't you priest-types supposed to be more patient and... I dunno, nicer?~
== BC0DRAKE ~I serve the god of justice, kid, not niceness. And often times justice is... not nice.~
== %IMOEN_BANTER% ~But it's always fair, right?~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeImoen2_BG1","GLOBAL",0)~ THEN %IMOEN_BANTER% C0DrakeImoen2
...
== %IMOEN_BANTER% ~Don't treat me like a kid, Drake! I'm of age. Besides, I've had plenty of ol' Puffgut's specialties.~
== BC0DRAKE ~I'm sure, but that particular bottle of brandy is far too good for your tongue.~
== %IMOEN_BANTER% ~Aw, c'mon, Drake. You're really gonna be a spoilsport when you drink ale like water? C'mon, just one sip!~
== BC0DRAKE ~*sigh* How can anyone be such a huge pain in the arse?~
== %IMOEN_BANTER% ~Ha! With lots of practice annoying <CHARNAME>, how else?~
...
== %IMOEN_BANTER% ~Pfft... e-hehehe! Yep, ya caught me! The look on your face wasn't as horrified as I expected, though. I was kinda disappointed by that.~
...
== %IMOEN_BANTER% ~Yeah, sure. But y'know, I saw your lips twitch a little, like you were trying to stop yourself from laughing.~
...
== %IMOEN_BANTER% ~Uhh... now that you mention it... you'll make sure that doesn't happen, right?~
== BC0DRAKE ~No promises. You're lucky I found this just a little funny.~
== %IMOEN_BANTER% ~(Please don't let him see the 'improvements' I made to his prayers...)~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeJaheira1_BG1","GLOBAL",0)~ THEN %JAHEIRA_BANTER% C0DrakeJaheira1
...
== %JAHEIRA_BANTER% ~I have no patience for your childish games, Drake. Whenever I slow my pace, you follow suit to remain behind me. I have no doubts as to where your attention truly is.~
...
== %JAHEIRA_BANTER% ~I felt it was fair to give you the benefit of the doubt at first. I know most Tyrrans to have enough standards to not ogle a married woman.~
== BC0DRAKE ~Ah. Sharp words, my lady. I can see why your husband is so easily cowed by your every word.~
== %JAHEIRA_BANTER% ~What? Why you-~
...
== %JAHEIRA_BANTER% ~*sigh* Why did you ever allow this bounder in our midst, <CHARNAME>?~
EXIT
...
== %JAHEIRA_BANTER% ~...Yes. A few. Though it is concerning that you, of all people, would come into contact with a Harper. What could you have done to draw their attention?~
== BC0DRAKE ~I... may have... stepped into their business from time to time. Ironic, given the Harpers' reputation for doing the same.~
== %JAHEIRA_BANTER% ~That is... worrisome to know. I ask that you tell me of your encounter with my fellows.~
...
== %JAHEIRA_BANTER% ~He simply told you that? I have never known a Harper to be so foolish.~
...
== %JAHEIRA_BANTER% ~You are more fortunate than you know, Drake. Some Harpers are merciless in maintaining secrecy. I hope you learned your lesson after such an experience.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeKagain1","GLOBAL",0)~ THEN %KAGAIN_BANTER% C0DrakeKagain1
...
== %KAGAIN_BANTER% ~Hmph. At least ye would not be wastin' it in the hands of some statue of Tyr or other rubbish.~
== BC0DRAKE ~Precisely, Kagain. When has that gold done any good for those who needed it, after all?~
== %KAGAIN_BANTER% ~But ye could've still done much for yerself with all that gold. Now ye'll never see it again, not in this lifetime.~
...
== %KAGAIN_BANTER% ~Hmm. Ye've made yer point, church-boy. Yer not such a fool after all.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeKhalid1","GLOBAL",0)~ THEN %KHALID_BANTER% C0DrakeKhalid1
~Y-you know, Drake...~
DO ~SetGlobal("C0DrakeKhalid1","GLOBAL",1)~
== BC0DRAKE ~Pardon? Hm, I could've sworn you said something, Khalid.~
== %KHALID_BANTER% ~I was going to b-b-bring up your peculiar battle stance. It's a common one taught to Amnian soldiers, is it not?~
== BC0DRAKE ~Oh, so you recognize it, do you? I never would've thought you'd have experience in the army, my friend.~
== %KHALID_BANTER% ~A-actually, I spent a few years training in the C-calimshan militia.~
...
== %KHALID_BANTER% ~It was m-my... my own choice, in fact. I... I was not my father's favorite, and it was the only thing I could find p-purpose in.~
...
== %KHALID_BANTER% ~N-no offense taken, Drake. Perhaps another time, we c-could compare our experiences as soldiers?~
...
== %KHALID_BANTER% ~Y-yes... exactly as you s-say, Drake.~
...
== %KHALID_BANTER% ~I-is there a cause for such d-dramatic statements, Drake? I d-do not wish to misjudge, but it sounds as though you are m-mocking me.~
== BC0DRAKE ~Come now, do you really think so little of me? Haven't we done more in the past than what I have spoken of?~
== %KHALID_BANTER% ~C-certainly we have. But wh-~
...
== %KHALID_BANTER% ~W-when you put it like that... it does seem a little s-silly to worry.~
...
== %KIVAN_BANTER% ~Then you are among the first, Drake. Have you lost one dear to yourself to a cruel and evil monster, as I have?~
...
== %KIVAN_BANTER% ~What manner of justice is it which cannot even bring peace to those you love?~
...
== %KIVAN_BANTER% ~You believe I have it easier? I know you have good intentions, but I would appreciate it if you did not trivialize my situation so.~
...
== %KIVAN_BANTER% ~I appreciate the offer, but I will pass. Some of us must use our tools with a level of finesse.~
EXIT
...
== %KIVAN_BANTER% ~You may ask. I do not promise to answer.~
== BC0DRAKE ~This murdering fiend that took your beloved's life... will you be satisfied once you've had your revenge?~
== %KIVAN_BANTER% ~I cannot see what the answer to such a question would mean to you, Drake.~
...
== %KIVAN_BANTER% ~Perhaps you are right. But revenge is all I have left to drive me. Once I have slain Tazok, I have no intention of remaining in this realm any longer. I shall make the journey to Arvandor, where my beloved Deheriana awaits me.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeMinsc1_BG1","GLOBAL",0)~ THEN %MINSC_BANTER% C0DrakeMinsc1
...
== %MINSC_BANTER% ~Now Boo is even more confused. You are a warrior, but not a warrior. But you are also a wise man, but not a wise man! You are talking in circles!~
...
== %DYNAHEIR_BANTER% IF ~InParty("DYNAHEIR")~ THEN ~It... becomes easier with knowledge. Thou shouldst leave our friend be, Minsc.~
EXIT
...
== %MONTARON_BANTER% ~What else? (grin) Want a taste?~
...
== %MONTARON_BANTER% ~Ah, just pullin' yer leg anyway, weak-knees.~
== BC0DRAKE ~Then why are you holding them to your mouth?~
== %MONTARON_BANTER% ~Heh heh. Never said anything about meself, did I, aye?~
...
== %QUAYLE_BANTER% ~That's because there is no one else quite like me, my big friend. Me and my amazing brain are one-of-a-kind.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeSafana1","GLOBAL",0)~ THEN %SAFANA_BANTER% C0DrakeSafana1
...
== %SAFANA_BANTER% ~Perhaps one or two might have qualified. It is *so* very hard to remember when you are the closest comparison I can make. Those men at least did not reek of cheap ale.~
== BC0DRAKE ~So it seems that my scents serve as a repellent for vicious harpies. Good to know!~
== %SAFANA_BANTER% ~Why, Drake, are you telling me you do not find me ravishing?~
...
== %SAFANA_BANTER% ~I'm almost hurt at your insinuations. Almost.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeSafana2","GLOBAL",0)~ THEN %SAFANA_BANTER% C0DrakeSafana2
...
== %SAFANA_BANTER% ~Oh, I didn't mean it that way. I was merely making a remark on how smug that face of yours is. Very... punchable.~
== BC0DRAKE ~Ha! You'd best get in line, then. I've heard that so many times it hurts more than the act itself.~
== %SAFANA_BANTER% ~Sometimes, Drake dear, I wonder if you hate yourself more than I hate you.~
EXIT
...
== %SAFANA_BANTER% ~You're only half-right, Drake. If your eyes weren't clouded with so much nonsense, you'd recognize I have *no* faults, dear. But I'll take the compliment anyways.~
...
== %SAFANA_BANTER% ~You'd compare me to an aged prune no doubt in her late fifties? Harsh, Drake.~
...
== %SAFANA_BANTER% ~Why, such insinuations... do you despise me so much, darling? How your words wound me so.~
...
== %SHARTEEL_BANTER% ~Do not talk to me, lecherous pig.~
...
== %SHARTEEL_BANTER% ~You heard me, pig. I've no interest in your taunts. At most, I've got a blade ready to shut you up.~
== BC0DRAKE ~By cutting out my tongue, I imagine? Come on, you can do better than that.~
== %SHARTEEL_BANTER% ~I was thinking of something much, much lower down. Keep talking. It'll just make the cutting more satisfying.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeSkie1","GLOBAL",0)~ THEN %SKIE_BANTER% C0DrakeSkie1
...
== %SKIE_BANTER% ~What? Did I say something wrong?~
...
== %SKIE_BANTER% ~Where we are? Is this suppose to be some kind of trick question? We're travelling with <CHARNAME>, of course, silly.~
...
== %SKIE_BANTER% ~No, of course not. I just thought you should look more the noble you're meant to be.~
...
== %SKIE_BANTER% ~Gosh, your frown is so scary with that scraggly beard. Did I say something wrong again?~
...
== %SKIE_BANTER% ~Hmph! Well, that's rude of you. Whatever did I do wrong this time?~
...
== %SKIE_BANTER% ~Eldoth? What's wrong with him? He's cleaner than you, at least, if you haven't noticed.~
...
== %SKIE_BANTER% ~Stop this! I won't have you standing here slandering my beloved! If you say one more bad thing about Eldoth, I'll... I'll-~
...
== %TIAX_BANTER% ~Hm? Are you truly daft enough to ask, foolish human?! The rise of Tiax's dynasty is all but inevitable!~
...
== %TIAX_BANTER% ~The day that you see Cyric's banner shall be the last day you see at all, Tyrran heretic! Revel in what time remains, for your days are numbered.~
== %TIAX_BANTER% ~Unless...~
== BC0DRAKE ~Oh, gods. This is the part where you try to coerce me into converting, isn't it?~
== %TIAX_BANTER% ~You are not quite as dim-witted as you appear, then. Good! You may be of use to Tiax's realms after all...~
== %TIAX_BANTER% ~...as a indentured shoveler of horse manure!~
...
== %TIAX_BANTER% ~Hmph! You had best believe that I will, fool! Live your days cowering in dread at what fate awaits you!~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeViconia1BG1","GLOBAL",0)~ THEN %VICONIA_BANTER% C0DrakeViconia1
...
== %VICONIA_BANTER% ~Your quips remind me of the youths in training at Arach-Tinilith, jaluk. They were punished with the removal of their tongues. A pity the surface does not encourage similar practices.~
== BC0DRAKE ~Oh, there are places that do that, certainly. Just not where I grew up.~
== %VICONIA_BANTER% ~Then perhaps you should find a place that does and wag that tongue of yours there instead. I'm sure they would appreciate the wit much more than I.~
...
== %VICONIA_BANTER% ~Your ignorance is beyond baffling, iblith. The brews of the Underdark are made of far more complex substances than that grown from the dirt of the surface.~
== BC0DRAKE ~Hmm. Well, that's disappointing. And here I thought perhaps you'd be happy for a taste of home.~
== %VICONIA_BANTER% ~Where drow concoctions are concerned, fool, it can be difficult seperating simple beverages from poison. A single dose of the wrong kind could leave you hanging between life and death.~
...
== %VICONIA_BANTER% ~The thought of having your life potentially in my grasp is tempting... but no. You've wasted enough of my time.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeXan1","GLOBAL",0)~ THEN %XAN_BANTER% C0DrakeXan1
...
== %XAN_BANTER% ~I speak of you, of course.~
== BC0DRAKE ~Ha! You must be joking. I find life to be quite a delight.~
== %XAN_BANTER% ~Yet you choose to waste away what life you have in your vices. Whether you know it or not, you have accepted your doom, and are resigned to it.~
...
== %XAN_BANTER% ~Regretfully, I must decline. I have no doubt your human beverages will fog my mind and cause me to forget about the doom we will inevitably face.~
EXIT
...
== %XAN_BANTER% ~Why? (sigh) Because it is pointless, why else? Seeking out pointless delusions to amuse me briefly will only make the inevitable more painful.~
== BC0DRAKE ~Oh, come now. It can't be worse than the pile of misery that you already are, can it?~
== %XAN_BANTER% ~If there is one thing that my experiences have taught me, then it is that everything can always get worse.~
== BC0DRAKE ~True. So what shall you do, just mope around until you finally reach rock bottom?~
== %XAN_BANTER% ~I could, but what is the point? (sigh) It will happen one way or another.~
EXIT
...
== %XZAR_BANTER% ~Now why would I ever do such a thing? And why would Mommy ever teach me that? Isn't the rain delightful? Why, I'm positively glowing with joy here! I can barely resist the urge to sing!~
== BC0DRAKE ~Please don't.~
== %XZAR_BANTER% ~Oh, don't be such as killjoy dafferdoodle. I'll have you know I can make quite a merry tune! Of course, 'tis better when accompanied with instruments made of human bone and bloody sinew, but even without, 'tis worth hearing!~
...
== %XZAR_BANTER% ~Hmf! Be that way, if you must. I will simply skip the singing and go straight into the dance routine instead! Oh, gorgeous, rainy, gloomy day!~
== BC0DRAKE ~You'll regret that when you end up with a case of shivers tonight.~
== %XZAR_BANTER% ~I know, Drake, wouldn't that be wonderful?~
...
== %XZAR_BANTER% ~Fie on you! Who would be so foolish as to SKIN a rabbit?! I adore the little beasts, did you not know that?~
== BC0DRAKE ~Do you really?~
== %XZAR_BANTER% ~Oh, most certainly. I do so enjoy watching their skeletons do a little jig.~
== BC0DRAKE ~So long as you're not the one rending the flesh off their bones, I take it?~
== %XZAR_BANTER% ~Why, I think you are beginning to understand me, Drakey.~
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeYeslick1","GLOBAL",0)~ THEN %YESLICK_BANTER% C0DrakeYeslick1
...
== %AJANTIS_BANTER% IF ~InParty("AJANTIS")~ THEN ~I will do no such thing!~
== BC0DRAKE IF ~InParty("AJANTIS")~ THEN ~You keep telling yourself that, kid.~
== %YESLICK_BANTER% ~'Tis character I speak of, lad, not appearances. Forgive me for saying so, but on that front, ye be... unusual.~
...
== %YESLICK_BANTER% ~Aye, but from yer habits, ye don't seem much o' a fit for servin' the god of justice. Why does ye stay?~
...
== %NEERA_BANTER% ~Ew, no. I was just thinking about how weird you are.~
== BC0DRAKE ~Me, weird? Isn't this a case of the pot calling the kettle rotten?~
== %NEERA_BANTER% ~Err... don't you mean 'pot calling the kettle black'?~
== BC0DRAKE ~I prefer my version of the saying.~
== %NEERA_BANTER% ~See what I mean? Weird.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeNeera","GLOBAL",1)~ THEN %NEERA_BANTER% C0DrakeNeera2
...
== %NEERA_BANTER% ~Ha! Don't worry, I won't surprise you with any thing wild... intentionally. Though I was going to ask... you don't seem *that* afraid of what I could do to you.~
...
== %NEERA_BANTER% ~It... could be much worse though, all joking aside. You know that, don't you?~
...
== %RASAAD_BANTER% ~Truly? Calimshan and Amn are not so far apart.~
...
== %RASAAD_BANTER% ~Monks of the Sun Soul Order frown upon materialism, that is true, but... are you suggesting you have never seen a Calishite free of greed?~
...
== %RASAAD_BANTER% ~I have many reasons. Some are my own to know... but I assure you, my sole wish is to gift the light of Selune towards other by doing what good I can.~
...
== %RASAAD_BANTER% ~I hope we will. Thank you for your show of confidence, Drake.~
EXIT
...
== %RASAAD_BANTER% ~Hmm... I do not think a taste is necessary. This scent alone is all too familiar. Where did you acquire Golden Sands of such quality, Drake?~
...
== %RASAAD_BANTER% ~The monks of the monastery rarely allowed us to drink. They say it has an impact on our skills and balance.~
== BC0DRAKE ~We're not exactly close to Calimshan right now, and I'm sure a small swig's never hurt anyone, right?~
== %RASAAD_BANTER% ~(smile) You did not let me finish, my friend. As children, my brother and I were always curious of the bottles in the cellars, rarely touched, yet occasionally vanishing into nowhere. We thought surely nobody would notice if two more went missing.~
== BC0DRAKE ~And did you...?~
== %RASAAD_BANTER% ~I am a little ashamed to say that we did. My brother and I drank an entire bottle each, and by the morning, we had passed out on the ground after trying to invent a new fighting style. The other monks were... displeased, to say the least.~
...
== %RASAAD_BANTER% ~I... it is still painful to think that Gamaz has passed. I missed him, and when I saw him again, he... well, you already know.~
...
== %RASAAD_BANTER% ~I know, Drake. Thank you.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("C0DrakeDorn","GLOBAL",0)~ THEN %DORN_BANTER% C0DrakeDorn
...
== %DORN_BANTER% ~I will, if you refuse to obey. You should know you stand no chance if I chose to.~
...
== %DORN_BANTER% ~I understand enough to know when I am being provoked, pawn. Make sure you understand this in return: it is only by the word of <CHARNAME> that you live. Should that change, you will not notice your head leaving your shoulders before it is too late.~
...
== %DORN_BANTER% ~Hmm. You may think yourself clever for saying such words, but I am ready for them. I consider <CHARNAME>'s commands because <PRO_HESHE> is a person with the potential for power and greatness. You, however, are fatally lacking in both.~
== BC0DRAKE ~I've never denied that part of myself. But I've known great men.~
== %DORN_BANTER% ~What foolishness would you consider greatness, pawn? Go on. Amuse me.~
